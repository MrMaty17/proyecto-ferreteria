                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php while ($fila = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><img src="../assets/image/<?php $fila['image'] !== null ? $fila['image'] : 'no_foto.png'?>" alt="Imagen" class="w-16 h-16 object-cover"></td>
